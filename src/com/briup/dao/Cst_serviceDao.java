...
public interface Cst_serviceDao {
	...
	public int getAllRowss2(Cst_service cst_service) throws Exception;
	 ...
	 * 
	 */
	public List<Cst_service> findByHQLCondition(Cst_service con, int curPage, int row) throws Exception;

	public List<Cst_service> findByHQLCondition1(Cst_service con, int curPage, int row) throws Exception;

	public List<Cst_service> findByHQLCondition2(Cst_service con, int curPage, int row) throws Exception;
